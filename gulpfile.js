...
gulp.task('server', () => {
    ...
    gulp.watch('./src/img/**/*.{png,jpg,svg}', gulp.series('clean-img','images', 'sprite', 'webp', 'html', 'refresh'));
    gulp.watch('./src/*.html', gulp.series('html', 'refresh'));
});

gulp.task('build', gulp.series('clean-build', 'copy', 'images', gulp.parallel('sprite', 'webp', 'font'), 'html'));
